...
glm::mat4 Model::GetWorldMatrix() const
{
	...
	if (!mAnimation)
	{
		// We initialize the 3 matrices
		mat4 translationMatrix = translate(mat4(1.0f), mPosition);
		mat4 rotationMatrix = rotate(mat4(1.0f), radians(mRotationAngleInDegrees), mRotationAxis);
		mat4 scalingMatrix = scale(mat4(1.0f), mScaling);
